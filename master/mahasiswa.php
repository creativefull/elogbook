...
$query = mysqli_query($connect,'SELECT usertbl.id,`userid`,`username`,`userpassword`,`usertypeid`,usertbl.nim FROM usertbl where `usertbl`.`usertypeid`=2',MYSQLI_USE_RESULT) or die("Gagal mengambil data");
$var1="1"; 
